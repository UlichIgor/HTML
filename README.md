...
* **\<video>** *Визначає вбудований відеовміст*.
* **\<source>** *Визначає кілька медіа-ресурсів для медіа-елементів (**\<video>** і **\<audio>**)*.
* **\<track>** *Визначає текстові доріжки для медіа-елементів (**\<video>** і **\<audio>**)*.
...
* **\<th>** *Визначає заголовок стовпця або рядка таблиці*.
* **\<tr>** *Визначає рядок таблиці*.
* **\<td>** *Визначає комірку таблиці*.
* **\<thead>** *Визначає групу заголовків стовпців таблиці*.
* **\<tbody>** *Визначає групу основного вмісту таблиці*.
* **\<tfoot>** *Визначає групу підсумків таблиці*.
...
* **\<details>** *Визначає додаткові деталі, які користувач може переглядати або приховувати*.
* **\<dialog>** *Визначає діалогове вікно або вікно*.
* **\<menu>** *Визначає список команд або меню*.
* **\<menuitem>** *Визначає команду, яку користувач може вибрати з меню*.
* **\<summary>** *Визначає заголовок для елемента **\<details>***.
